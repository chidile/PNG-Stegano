...
root = Tk()
root.title("PNGStegano - Hide a secret text message in an image.")
root.geometry("700x500+250+80")
...
Label(root, text="CYBER STEGANO", bg="#2d4155",fg="white",font="arial 25 bold").place(x=100, y=20)
...
Label(frame3, text="Picture, Image, Photo Files",bg="#2f4155", fg="yellow").place(x=20, y=5)
